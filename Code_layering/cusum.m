...
line([1 n],climit*[1 1],'LineStyle',':','Color',get(hLines(1),'Color'));
line([1 n],-climit*[1 1],'LineStyle',':','Color',get(hLines(2),'Color'));
...
hAxes = get(hLines(1),'Parent');
YLim  = get(hAxes,'YLim');
set(hAxes,'YLim',[min(-climit-1,YLim(1)), max(climit+1,YLim(2))]);
