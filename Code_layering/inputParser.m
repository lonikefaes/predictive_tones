...
%       PartialMatching -   If true, inputParser will allow partial string
...
%   possible matches to the input string, MATLAB throws an error. If
%   FALSE, the input names are required to match a parameter name
%   exactly (with respect to the CaseSensitive property.)
PartialMatching
