function [cVertices, cFaces] = clipMeshVerticesSphere(vertices, faces, P,radius)
...
% clip the vertices
%[cVertices, indVertices] = clipPoints3d(vertices, rad);

[cVertices, indVertices] = clipPointsSphare3d(vertices,P,radius);

%indVertices = unique(faces(logical(sum(ismember(faces,indVertices0),2)),:));
