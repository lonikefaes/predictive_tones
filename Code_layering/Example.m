...
getderivatives=0;
[PrincipalCurvatures,PrincipalDir1,PrincipalDir2,FaceCMatrix,VertexCMatrix,Cmagnitude]= GetCurvatures( FV_EV{1},getderivatives);
...
mesh_h=patch(FV_EV{1},'FaceVertexCdata',GausianCurvature','facecolor','interp','edgecolor','interp','EdgeAlpha',0.2);
